...
.method private setupEqualizerFxAndUI()V
    ...
    iget-object v14, p0, Lio/appium/android/apis/media/AudioFxDemo;->mMediaPlayer:Landroid/media/MediaPlayer;

    invoke-virtual {v14}, Landroid/media/MediaPlayer;->getAudioSessionId()I

    move-result v14

    invoke-direct {v12, v13, v14}, Landroid/media/audiofx/Equalizer;-><init>(II)V

    iput-object v12, p0, Lio/appium/android/apis/media/AudioFxDemo;->mEqualizer:Landroid/media/audiofx/Equalizer;

    .line 99
    iget-object v12, p0, Lio/appium/android/apis/media/AudioFxDemo;->mEqualizer:Landroid/media/audiofx/Equalizer;

    const/4 v13, 0x1

    invoke-virtual {v12, v13}, Landroid/media/audiofx/Equalizer;->setEnabled(Z)I
    ...
    .line 102
    .local v3, "eqTextView":Landroid/widget/TextView;
    const-string v12, "Equalizer:"

    invoke-virtual {v3, v12}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 103
    iget-object v12, p0, Lio/appium/android/apis/media/AudioFxDemo;->mLinearLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v12}, Landroid/media/audiofx/Equalizer;->getNumberOfBands()S
    ...
    invoke-virtual {v12}, Landroid/media/audiofx/Equalizer;->getBandLevelRange()[S
    ...
    aget-short v8, v12, v13

    .line 110
    .local v8, "maxEQLevel":S
    const/4 v5, 0x0
    ...
    .line 114
    .local v4, "freqTextView":Landroid/widget/TextView;
    ...
    iget-object v13, p0, Lio/appium/android/apis/media/AudioFxDemo;->mEqualizer:Landroid/media/audiofx/Equalizer;

    invoke-virtual {v13, v0}, Landroid/media/audiofx/Equalizer;->getCenterFreq(S)I
    ...
    .line 125
    .local v9, "minDbTextView":Landroid/widget/TextView;
    new-instance v12, Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 131
    .local v7, "maxDbTextView":Landroid/widget/TextView;
    new-instance v12, Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 141
    .local v2, "bar":Landroid/widget/SeekBar;
    invoke-virtual {v2, v6}, Landroid/widget/SeekBar;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 142
    sub-int v12, v8, v10

    invoke-virtual {v2, v12}, Landroid/widget/SeekBar;->setMax(I)V

    .line 143
    iget-object v12, p0, Lio/appium/android/apis/media/AudioFxDemo;->mEqualizer:Landroid/media/audiofx/Equalizer;

    invoke-virtual {v12, v0}, Landroid/media/audiofx/Equalizer;->getBandLevel(S)S

    move-result v12

    invoke-virtual {v2, v12}, Landroid/widget/SeekBar;->setProgress(I)V

    .line 145
    new-instance v12, Lio/appium/android/apis/media/AudioFxDemo$2;

    invoke-direct {v12, p0, v0, v10}, Lio/appium/android/apis/media/AudioFxDemo$2;-><init>(Lio/appium/android/apis/media/AudioFxDemo;SS)V

    invoke-virtual {v2, v12}, Landroid/widget/SeekBar;->setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V
    ...
    .line 161
    .end local v0    # "band":S
    .end local v2    # "bar":Landroid/widget/SeekBar;
    .end local v4    # "freqTextView":Landroid/widget/TextView;
    .end local v6    # "layoutParams":Landroid/widget/LinearLayout$LayoutParams;
    .end local v7    # "maxDbTextView":Landroid/widget/TextView;
    .end local v9    # "minDbTextView":Landroid/widget/TextView;
...
.method private setupVisualizerFxAndUI()V
    ...
    invoke-virtual {v0, v1, v2, v5, v3}, Landroid/media/audiofx/Visualizer;->setDataCaptureListener(Landroid/media/audiofx/Visualizer$OnDataCaptureListener;IZZ)I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lio/appium/android/apis/media/AudioFxDemo;->mStatusTextView:Landroid/widget/TextView;
    ...
    const-string v2, "MediaPlayer audio session ID: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lio/appium/android/apis/media/AudioFxDemo;->mMediaPlayer:Landroid/media/MediaPlayer;
