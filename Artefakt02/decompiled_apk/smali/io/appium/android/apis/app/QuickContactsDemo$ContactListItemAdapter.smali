...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget-object v6, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->nameBuffer:Landroid/database/CharArrayBuffer;

    invoke-interface {p3, v5, v6}, Landroid/database/Cursor;->copyStringToBuffer(ILandroid/database/CharArrayBuffer;)V

    .line 80
    iget-object v5, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->nameBuffer:Landroid/database/CharArrayBuffer;

    iget v4, v5, Landroid/database/CharArrayBuffer;->sizeCopied:I

    .line 81
    .local v4, "size":I
    iget-object v5, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->nameView:Landroid/widget/TextView;

    iget-object v6, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->nameBuffer:Landroid/database/CharArrayBuffer;

    iget-object v6, v6, Landroid/database/CharArrayBuffer;->data:[C

    invoke-virtual {v5, v6, v7, v4}, Landroid/widget/TextView;->setText([CII)V
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    new-instance v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;

    invoke-direct {v0}, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;-><init>()V
    ...
    iput-object v2, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->nameView:Landroid/widget/TextView;
    ...
    iput-object v2, v0, Lio/appium/android/apis/app/QuickContactsDemo$ContactListItemCache;->photoView:Landroid/widget/QuickContactBadge;
